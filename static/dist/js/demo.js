(function ($) {
    ...
    var $dark_mode_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("dark-mode"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $header_fixed_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("layout-navbar-fixed"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $dropdown_legacy_offset_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".main-header").hasClass("dropdown-legacy"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $no_border_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".main-header").hasClass("border-bottom-0"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $sidebar_mini_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("sidebar-mini"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $sidebar_mini_md_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("sidebar-mini-md"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $sidebar_mini_xs_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("sidebar-mini-xs"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $flat_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".nav-sidebar").hasClass("nav-flat"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $legacy_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".nav-sidebar").hasClass("nav-legacy"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $compact_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".nav-sidebar").hasClass("nav-compact"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $child_indent_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".nav-sidebar").hasClass("nav-child-indent"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $child_hide_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".nav-sidebar").hasClass("nav-collapse-hide-child"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $no_expand_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".main-sidebar").hasClass("sidebar-no-expand"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $footer_fixed_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("layout-footer-fixed"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $text_sm_body_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $("body").hasClass("text-sm"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $text_sm_header_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".main-header").hasClass("text-sm"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $text_sm_brand_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".brand-link").hasClass("text-sm"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $text_sm_sidebar_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".nav-sidebar").hasClass("text-sm"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
    ...
    var $text_sm_footer_checkbox = $("<input />", { type: "checkbox", value: 1, checked: $(".main-footer").hasClass("text-sm"), class: "mr-1" }).on("click", function () {
        if ($(this).is(":checked")) {
